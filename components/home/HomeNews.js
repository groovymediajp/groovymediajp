  ...
  return (
    <div className='bg-white pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8'>
      <div className='relative max-w-lg mx-auto lg:max-w-7xl'>
        <div>
          <h2 className='text-center text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl'>お知らせ</h2>
        </div>
        <div
          className={
            singlecolumn ? 'mt-12 max-w-prose mx-auto' : 'mt-6 grid gap-16 pt-6 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-12'
          }
        >
          {posts.map((post) => (
            <div key={post.slug} className={singlecolumn ? 'mb-6 pb-6 ' : ''}>
              ...
              <div className='mt-6 flex items-center'>
                ...
                <div className='ml-3'>
                  <p className='text-sm font-medium text-gray-900'>GroovyMedia Staff</p>
                  <div className='flex space-x-1 text-sm text-gray-500'>
                    <time dateTime={post.publishedAt}>{dateFormat(post.publishedAt, true)}</time>
